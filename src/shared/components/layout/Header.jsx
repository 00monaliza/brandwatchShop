...
import { LanguageSwitcher, MobileLanguageSwitcher } from '../ui/LanguageSwitcher';
      ...
      <div className="header-container">
        ...
        <div className="header-right">
          ...
          <div className="header-icons">
            <button className="icon-btn" title={t('header.search')} aria-label={t('header.search')} onClick={() => setShowSearchModal(true)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <circle cx="11" cy="11" r="8"></circle>
                <path d="m21 21-4.35-4.35"></path>
              </svg>
            </button>
            <Link to="/favorites" className="icon-btn" title={t('header.favorites')} aria-label={t('header.favorites')}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

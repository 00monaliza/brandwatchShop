...
const FilterGroup = memo(({ filterKey, title, isExpanded, searchQuery, selectedValues, onToggle, onSearchChange, onCheckboxChange }) => {
          ...
          <div className="filter-search-wrapper">
            ...
            {searchQuery && (
              <button
                ...
                onClick={() => onSearchChange(filterKey, '')}
              >
                ×
              </button>
            )}
        ...
        <div className="filter-groups">
          {Object.keys(FILTER_OPTIONS).map(key => (
            <FilterGroup
              ...
              filterKey={key}
              title={t(`filters.${key}`)}
              isExpanded={expandedFilters[key]}

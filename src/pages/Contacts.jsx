            ...
            <div className="contact-info">
              ...
              <div className="info-cards">
                ...
                <div className="info-card">
                  ...
                  <div className="info-content">
                    ...
                    <p>{t('contacts.weekdays')}: 10:00 - 20:00</p>
                    <p>{t('contacts.weekend')}: 11:00 - 18:00</p>
                  </div>
                </div>
              </div>
              ...
              <div className="social-links">
                ...
                <div className="social-icons">
                  ...
                  <a href="https://wa.me/77771234567" target="_blank" rel="noopener noreferrer" className="social-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://t.me/brandwatch" target="_blank" rel="noopener noreferrer" className="social-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="contact-form-wrapper">
              ...
              <form onSubmit={handleSubmit} className="contact-form">
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label htmlFor="subject">{t('contacts.formSubject')}</label>
                    <input
                      type="text"
                      id="subject"
                      name="subject"
